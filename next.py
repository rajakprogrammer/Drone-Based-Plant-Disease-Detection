...
class Mavic(Robot):
    ...
    def capture_image(self):
        ...
        image_array = np.frombuffer(
            image, np.uint8).reshape((height, width, 4))
    ...
    def run(self):
        ...
        while self.step(self.time_step) != -1:
            ...
            file_path = "captured_image.png"  # Specify the file path
            captured_image.save(file_path)

            # Additional processing or actions with the captured image can be done here
